...
GENERIC_RESPONSE_MESSAGE = "This is a generic response"
...
def test_response_failure_from_empty_invalid_request():
    ...
    response = build_response_from_invalid_request(invalid_request)
...
def test_response_failure_from_invalid_request_with_errors():
    invalid_request = RoomListInvalidRequest()
    invalid_request.add_error("path", "Is mandatory")
    invalid_request.add_error("path", "can't be blank")
    response = build_response_from_invalid_request(invalid_request)
